...
private:
  ...
  int hListenerSocket;                                                 // Listener socket for inbound connections
  int  hClientSocket;                                                   // Client socket for the game conversation (post-accept)
  char ClientDesc[128];                                                   // Client's host details
  struct sockaddr_in clientSockAddr;                                             // Socket structure for bind
  u_int clientSockSize;                                                     // Size of client socket!
